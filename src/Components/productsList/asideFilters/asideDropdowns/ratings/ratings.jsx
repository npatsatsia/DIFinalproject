...
const Ratings = () => {
  ...
  return (
    <div className='list-ratings-container'>
      <div className='products-filters-title' onClick={() => (setShow(prev => !prev))}>
        <h6 className='title-h6'>Ratings</h6>
      ...
      <div className={`ratings-filter ${show? 'show-filters' : ''}`}>
        <div className='ratings-check pdtb7'>
          <input type="checkbox" name="five-star" id="five-star" className='checkbox' />
          <label htmlFor="five-star">
            <svg xmlns="http://www.w3.org/2000/svg" width="93" height="18" viewBox="0 0 93 18" fill="none" className='pl10'>
        ...
        <div className='ratings-check pdtb7'>
          <input type="checkbox" name="four-stars" id="four-stars" className='checkbox'/>
        ...
        <div className='ratings-check pdtb7'>
          <input type="checkbox" name="three-stars" id="three-stars" className='checkbox' />
        ...
        <div className='ratings-check pdtb7'>
          <input type="checkbox" name="two-stars" id="two-stars" className='checkbox' />
